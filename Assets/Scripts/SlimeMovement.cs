    ...
    void Update()
    {
        ...
        if(Math.Abs(x - goal_x) < 0.01f && Math.Abs(y - goal_y) < 0.01f) {
            ...
            while(i<4) {
                ...
                if(visited[w+direction[0], l+direction[1]] == false && (grid[w+direction[0], l+direction[1]][0] == TileType.FLOOR || grid[w+direction[0], l+direction[1]][0] == TileType.HEALTH || grid[w+direction[0], l+direction[1]][0] == TileType.TRAP)) {
